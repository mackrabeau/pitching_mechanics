...
<mujoco model="PitcherFullBody">
  ...
  <default>
    <joint type="hinge" damping="2.0" limited="true"/>
    <position kp="80" kv="8"/>
    <geom type="capsule" density="900"/>
  ...
  <actuator>
    <!-- trunk -->
    <position name="trunk_yaw"   joint="trunk_yaw"   kp="120" kv="12"/>
    <position name="trunk_pitch" joint="trunk_pitch" kp="120" kv="12"/>
    <position name="trunk_roll"  joint="trunk_roll"  kp="120" kv="12"/>
    <!-- throw arm -->
    <position name="throw_shoulder_yaw"   joint="throw_shoulder_yaw"   kp="60" kv="6"/>
    <position name="throw_shoulder_pitch" joint="throw_shoulder_pitch" kp="60" kv="6"/>
    <position name="throw_shoulder_roll"  joint="throw_shoulder_roll"  kp="60" kv="6"/>
    <position name="throw_elbow_flex"     joint="throw_elbow_flex"     kp="80" kv="8"/>
    <!-- glove arm -->
    <position name="glove_shoulder_yaw"   joint="glove_shoulder_yaw"   kp="60" kv="6"/>
    <position name="glove_shoulder_pitch" joint="glove_shoulder_pitch" kp="60" kv="6"/>
    <position name="glove_shoulder_roll"  joint="glove_shoulder_roll"  kp="60" kv="6"/>
    <position name="glove_elbow_flex"     joint="glove_elbow_flex"     kp="80" kv="8"/>
    <!-- rear leg -->
    <position name="rear_hip_yaw"    joint="rear_hip_yaw"    kp="100" kv="10"/>
    <position name="rear_hip_pitch"  joint="rear_hip_pitch"  kp="100" kv="10"/>
    <position name="rear_hip_roll"   joint="rear_hip_roll"   kp="100" kv="10"/>
    <position name="rear_knee_flex"  joint="rear_knee_flex"  kp="120" kv="12"/>
    <position name="rear_ankle_flex" joint="rear_ankle_flex" kp="60"  kv="6"/>
    <!-- lead leg -->
    <position name="lead_hip_yaw"    joint="lead_hip_yaw"    kp="100" kv="10"/>
    <position name="lead_hip_pitch"  joint="lead_hip_pitch"  kp="100" kv="10"/>
    <position name="lead_hip_roll"   joint="lead_hip_roll"   kp="100" kv="10"/>
    <position name="lead_knee_flex"  joint="lead_knee_flex"  kp="120" kv="12"/>
    <position name="lead_ankle_flex" joint="lead_ankle_flex" kp="60"  kv="6"/>
  </actuator>
</mujoco>
"""
